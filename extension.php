...
class NewsAssistantExtension extends Minz_Extension
{
	...
	public function handleConfigureAction()
	{
		...
		if (Minz_Request::isPost()) {
			...
			FreshRSS_Context::$system_conf->provider = Minz_Request::param('provider', 'openai');
			...
			FreshRSS_Context::$system_conf->fields = array_values(array_filter(array_map('trim', explode(',', Minz_Request::param('fields', 'title,content'))), 'strlen'));
